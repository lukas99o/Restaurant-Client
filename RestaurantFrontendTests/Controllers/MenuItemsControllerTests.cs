...
namespace Restaurant_Frontend_Tests.Controllers
{
    public class MenuItemsControllerTests
    {
        ...
        public async Task Index_ReturnsViewWithMenuItemsFromApi()
        {
            ...
            var controller = new MenuItemsController(new HttpClient(handler));
        ...
        {
            var controller = new MenuItemsController(new HttpClient(new DelegatingHandlerStub((_, __) => new HttpResponseMessage(HttpStatusCode.OK))));
